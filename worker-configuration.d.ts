/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e51b7b6ae484502cb02fdca8710d89f3)
// Runtime types generated with workerd@1.20260518.1 2026-05-19 nodejs_compat
interface __BaseEnv_Env {
	PASSWORD: "admin";
	CONFIG_SYNC: DurableObjectNamespace<import("./src/index").ConfigSync>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConfigSync";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PASSWORD">> {}
}
